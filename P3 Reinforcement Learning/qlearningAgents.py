...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        actionQValuesPairs = {action: Q for action, Q in zip(actions, qValues)}
        return max(actionQValuesPairs, key=actionQValuesPairs.get)
